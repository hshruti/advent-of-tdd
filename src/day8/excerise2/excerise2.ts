...
export function getGhostSteps (input:string): number {
    let startArr: any = [];
    if (input) { 
        let direction: any = [];
        let map:any = {};
        ...
        return startArr.map((start:string) => {
...
console.log('Day 8 excerise 2 o/p :', getGhostSteps(data));
